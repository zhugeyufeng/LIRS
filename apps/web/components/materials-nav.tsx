...
import { ClipboardList, ShoppingCart, TestTube2, FlaskConical, Boxes } from "lucide-react";

export type MaterialsNavKey = "standards" | "reagents" | "consumables" | "requests" | "purchases";
...
export function MaterialsNav({ active, admin = false }: { active: MaterialsNavKey; admin?: boolean }) {
  ...
  const items = [
    { key: "standards" as const, label: "标准品/标准物质", href: `${basePath}/standards`, icon: TestTube2 },
